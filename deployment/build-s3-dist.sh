...
echo "pip install $deployment_dir/../source/thumbor/. --target=$VIRTUAL_ENV/lib/python2.7/site-packages/"
pip install $deployment_dir/../source/thumbor/. --target=$VIRTUAL_ENV/lib/python2.7/site-packages/
