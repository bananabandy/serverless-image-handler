...
echo "pip install $deployment_dir/../source/thumbor-6.4.2/. --target=$VIRTUAL_ENV/lib/python2.7/site-packages/"
pip install $deployment_dir/../source/thumbor-6.4.2/. --target=$VIRTUAL_ENV/lib/python2.7/site-packages/
